...
const meta = {
    ...
    cat_id:       null,
    cat_name:     'SIKU BESAR',
    description:  'Template Besi Siku Besar — A4 landscape, 15 kolom, ukuran > 70',
    custom_fields: [],
};
...
function render({ items, customValues }) {
    ...
    items.forEach(item => {
        ...
        // Skip items smaller than or equal to 70 (siku besar only)
    ...
    const headerRow3 = [
        ...
        h('EQ',         { border: [true, false, true, true] }),
        h('Cash'), h('Kredit'),
        h('Cash'), h('Kredit'),
