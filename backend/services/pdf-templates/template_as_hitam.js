...
function render({ items, customValues }) {
    ...
    const rows = items.map(function (item) {
        ...
        return {
            _weight: weight,
            cells: [
                { text: 'S 45 C',            alignment: 'center', fontSize: 12 },
    ...
    const hFill = '#E8ECF0';
    const headerGroup = [
        { text: 'GRADE',  alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: 'DIA.',   alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
    ...
    const headerSub = [
        { text: '',         alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(mm)',     alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(kg)',     alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(Rp/kg)', alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(Rp/btg)',alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(Rp/kg)', alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
        { text: '(Rp/btg)',alignment: 'center', bold: true, fontSize: 12, fillColor: hFill },
    ];
