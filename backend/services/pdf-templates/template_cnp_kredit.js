...
const meta = {
    ...
    cat_id:       null,
    cat_name:     'CNP',
    description:  'Template CNP — harga kredit gudang, A5 landscape',
    custom_fields: [
...
function render({ items, customValues }) {
    ...
    const rows = items.map(function (item) {
        ...
        const kg     = (item.prices && item.prices.kredit_gudang && item.prices.kredit_gudang.current) || 0;
